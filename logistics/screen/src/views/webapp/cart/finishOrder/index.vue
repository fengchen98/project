    ...
    <div class="orderBox">
      ...
      <div class="row-2">
        ...
        <div class="orderInfoBox">
          ...
          <div>
            <span>下单用户: </span><span v-text="orderObj.user_name" />
          </div>
          <div>
          ...
          <div><span>订单备注: </span><span v-text="orderObj.remark || '无'" /></div>
      ...
      <div v-if="orderObj.status === '1'" class="row-4">
      ...
      axios
        ...
        .then((res) => {
          ...
          if (this.orderObj.status === '0') {
            ...
            this.$router.push(`/webapp/pay/${this.orderNumber}`)
          }
